...
const Articles = () => {
  ...
  const pageContent = {
    ...
    en: {
      ...
      description: 'Discover a variety of articles written by students of the institution',
    },
    fr: {
      tag: 'Articles',
      title: 'Articles et opinions diverses',
      description: 'Découvrez une variété d\'articles écrits par les élèves de l\'institution',
    },
  };
  ...
  return (
    <>
      <Helmet>
        <title>{t('nav', 'articles')} - {t('common', 'siteName')}</title>
