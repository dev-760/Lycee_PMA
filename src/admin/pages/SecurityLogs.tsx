                ...
                <div className="bg-white rounded-xl p-4 shadow-card border border-gray-100 flex flex-col sm:flex-row gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pr-12 pl-4 py-3 rounded-xl border border-gray-200 bg-white text-charcoal placeholder:text-gray-400 focus:ring-2 focus:ring-red-500/30 focus:border-red-500 outline-none transition-all"
                        />
                    </div>
                    <select
                        value={filterType}
